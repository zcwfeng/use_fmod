...
jstring Java_top_zcwfeng_fmod_PlaySound_getButtonLabel(JNIEnv *env, jobject thiz, jint index)
{
...
Java_top_zcwfeng_fmod_PlaySound_buttonDown(JNIEnv *env, jobject thiz, jint index)
{
...
extern "C"
JNIEXPORT void JNICALL
Java_top_zcwfeng_fmod_PlaySound_buttonUp(JNIEnv *env, jobject thiz, jint index)
{
    gDownButtons &= ~(1 << index);
}
...
extern "C"
JNIEXPORT void JNICALL
Java_top_zcwfeng_fmod_PlaySound_setStateCreate(JNIEnv *env, jobject thiz)
{
...
extern "C"
JNIEXPORT void JNICALL
Java_top_zcwfeng_fmod_PlaySound_setStateStart(JNIEnv *env, jobject thiz)
{
	gSuspendState = false;
}
...
extern "C"
JNIEXPORT void JNICALL
Java_top_zcwfeng_fmod_PlaySound_setStateStop(JNIEnv *env, jobject thiz)
{
	gSuspendState = true;
}
...
extern "C"
JNIEXPORT void JNICALL
Java_top_zcwfeng_fmod_PlaySound_setStateDestroy(JNIEnv *env, jobject thiz)
{
	gQuitState = true;
}
...
extern "C"
JNIEXPORT void JNICALL
Java_top_zcwfeng_fmod_PlaySound_main(JNIEnv *env, jobject thiz)
{
	gJNIEnv = env;
