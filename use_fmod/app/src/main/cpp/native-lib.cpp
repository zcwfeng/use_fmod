...
Java_top_zcwfeng_fmod_FmodChangeVoice_voiceChangeNative(JNIEnv *env, jobject thiz, jint mode,
    ...
    try {
        ...
        switch (mode) {
            case USE_FMOD_CUSTOM_COMMON_MODE_NORMAL:
                _content = "原生：播放完毕";
                break;
            case USE_FMOD_CUSTOM_COMMON_MODE_LUOLI:
                _content = "萝莉：播放完毕";
                ...
                break;
            case USE_FMOD_CUSTOM_COMMON_MODE_DASHU:
                _content = "大叔：播放完毕";
                ...
                channel->addDSP(0, dsp);
                break;
            case USE_FMOD_CUSTOM_COMMON_MODE_GAOGUAI:
                ...
                break;
            case USE_FMOD_CUSTOM_COMMON_MODE_JINGSONG:
                _content = "惊悚音 播放完毕";
                //大叔
                system->createDSPByType(FMOD_DSP_TYPE_PITCHSHIFT, &dsp);
                ...
                break;
            case USE_FMOD_CUSTOM_COMMON_MODE_KONGLING:
                _content = "空灵：播放完毕";
                //回音 ECHO
                system->createDSPByType(FMOD_DSP_TYPE_ECHO, &dsp);
                // 延迟声音
